...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post producers_url, params: { producer: { category_id: @producer.category_id, discription: @producer.discription, location_id: @producer.location_id, name: @producer.name } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { category_id: @producer.category_id, discription: @producer.discription, location_id: @producer.location_id, name: @producer.name } }
